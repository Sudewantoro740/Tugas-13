...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="card">
				<div class="card-header bg-dark text-white" align="center">
					<p class="h4">GRAFIK LINE COVID-19</p>
				</div>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{ 
					...
					label: 'New Cases',
        			borderColor: 'rgba(16, 23, 230, 1)',
					fill: false
				},{
					data: <?php echo json_encode($total_death); ?>,
					label: 'Total Deaths',
        			borderColor: 'rgba(243, 255, 15, 1)',
					fill: false
				},{
					data: <?php echo json_encode($new_death); ?>,
					label: 'New Deaths',
        			borderColor: 'rgba(51, 255, 15, 1)',
					fill: false
				},{
					data: <?php echo json_encode($total_recovered); ?>,
					label: 'Total Recovered',
        			borderColor: 'rgba(40, 237, 191, 1)',
					fill: false
				},{
					data: <?php echo json_encode($active_cases); ?>,
					label: 'Active Cases',
        			borderColor: 'rgba(230, 16, 190, 1)',
					fill: false
				}
			]
			},
