...
while($row = mysqli_fetch_array($total)){
	...
	$query = mysqli_query($koneksi,"select sum(total_death) as total_death from cases where id_country='".$row['id_country']."'");
	$row = $query->fetch_array();
	$cases[] = $row['total_death'];
}
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="card ">
				<div class="card-header bg-dark text-white" align="center">
					<p class="h4">GRAFIK TOTAL DEATHS COVID-19</p>
				</div>
			<div class="card-body">
