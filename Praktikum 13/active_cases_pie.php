...
while($row = mysqli_fetch_array($total)){
	...
	$query = mysqli_query($koneksi,"select sum(active_cases) as active_cases from cases where id_country='".$row['id_country']."'");
...
<body>
	...
	<div class="card ">
				<div class="card-header bg-dark text-white" align="center">
					<p class="h4">GRAFIK ACTIVE CASES COVID-19</p>
				</div>
			<div class="card-body">
